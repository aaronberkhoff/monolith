...
class State:
    ...
    def __init__(self, position: numpy.ndarray[numpy.float64[3, 1]]=..., velocity: numpy.ndarray[numpy.float64[3, 1]]=..., acceleration: numpy.ndarray[numpy.float64[3, 1]]=..., time: TimeParameter=TimeParameter()) -> None:
        ...
...
class OrbitalElements:
    ...
    def __init__(self, sma: float=7000.0, ecc: float=0.0, inc: float=0.0, raan: float=0.0, arg: float=0.0, nu: float=0.0) -> None:
        ...

    def get_state(self, mu: float) -> State:
        ...
...
class NBody(Dynamic):
    ...
    def __init__(self, bodies: list[CelestialBody], central_body: CelestialBody) -> None:
        ...
